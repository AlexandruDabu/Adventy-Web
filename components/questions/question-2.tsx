...
export function Question2({ onAnswer }: Question2Props) {
  const options = [
    {
      value: "energetic",
      label: "Energetic & Ready to Move",
      description: "I wake up ready to be active",
    },
    {
      value: "peaceful",
      label: "Peaceful & Contemplative",
      description: "I enjoy quiet morning reflection",
    },
    {
      value: "hungry",
      label: "Excited to Cook & Eat",
      description: "Food is my morning motivation",
    },
    {
      value: "inspired",
      label: "Looking for Inspiration",
      description: "I seek daily motivation and quotes",
    },
  ]
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-background to-secondary/20">
      <div className="w-full max-w-2xl space-y-8 animate-in fade-in duration-700">
        ...
        <div className="text-center space-y-4">
          ...
          >
            How do you feel when you wake up during December?
          </motion.p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground">2 of 8</p>
      </div>
    </div>
  )
}
